...
var api = {
    ...
    * */
    ...
    auth: function (data) {
        return new Promise(function (resolve, reject) {
            $.post(api.baseUrl + '/x191202/auth',
                /*接收参数-start*/
                {
                    name: data.name,        //姓名
                    card_id: data.card_id,  //身份证后4位
                },
                /*接收参数-end*/
                function (res) {
                    api.debug && console.log(res);
    ...
    get_prize: function () {
        return new Promise(function (resolve, reject) {
            $.get(api.baseUrl + '/x191202/get_prize',
                function (res) {
                    api.debug && console.log(res);
                    resolve(res);
                });
    ...
    random_prize: function () {
        return new Promise(function (resolve, reject) {
            $.post(api.baseUrl + '/x191202/random_prize',
                function (res) {
                    api.debug && console.log(res);
                    resolve(res);
                });
    ...
    prize: function () {
        return new Promise(function (resolve, reject) {
            $.post(api.baseUrl + '/x191202/prize',
                function (res) {
                    api.debug && console.log(res);
                    resolve(res);
                });
    ...
    share: function () {
        return new Promise(function (resolve, reject) {
            $.post(api.baseUrl + '/x191202/share',
                function (res) {
                    api.debug && console.log(res);
                    resolve(res);
                });
