    ...
    * */
    ...
    user: function () {
        return new Promise(function (resolve, reject) {
            $.get(api.baseUrl + '/x200817/site2_2/user',
                function (res) {
    ...
    post: function (data) {
        return new Promise(function (resolve, reject) {
            $.post(api.baseUrl + '/x200817/site2_2/post',
                /*接收参数-start*/
                {
                    name: data.name,      //姓名
                    phone: data.phone,    //电话
    ...
    prizeUser: function () {
        return new Promise(function (resolve, reject) {
            $.get(api.baseUrl + '/x200817/site2_2/prize_user',
                function (res) {
                    api.debug && console.log(res);
                    resolve(res);
                });
    ...
    prize: function () {
        return new Promise(function (resolve, reject) {
            $.post(api.baseUrl + '/x200817/site2_2/prize',
                function (res) {
                    api.debug && console.log(res);
                    resolve(res);
                });
