...
var api = {
    ...
    * */
    ...
    prize: function () {
        return new Promise(function (resolve, reject) {
            $.post(api.baseUrl + '/x191216a/prize',
                function (res) {
                    api.debug && console.log(res);
                    resolve(res);
                });
    ...
    post: function (data) {
        return new Promise(function (resolve, reject) {
            $.post(api.baseUrl + '/x191216a/post',
                /*接收参数-start*/
                {
                    name: data.name,              //姓名
                    phone: data.phone,            //电话
     ...
     * 分享
     */
    share: function (target_user_id) {
        return new Promise(function (resolve, reject) {
            $.post(api.baseUrl + '/x191216a/share',
                {
    ...
    likes: function (target_user_id) {
        return new Promise(function (resolve, reject) {
            $.post(api.baseUrl + '/x191216a/likes',
                {
                    target_user_id:  target_user_id
                },
                function (res) {
