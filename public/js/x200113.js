...
var api = {
    ...
    * */
    ...
    users: function (data) {
        return new Promise(function (resolve, reject) {
            $.post(api.baseUrl + '/x200113/users',
                /*接收参数-start*/
                {
                    per_page: data.per_page,              //每页显示数量
                    current_page: data.current_page,      //当前页数
                    order: data.order,                     // new:按最新照片排序,hot:按人气排序
                    search:data.search                    //搜索
                },
                function (res) {
                    api.debug && console.log(res);
                    resolve(res);
    ...
    detail: function (id) {
        return new Promise(function (resolve, reject) {
            $.post(api.baseUrl + '/x200113/detail',
                /*接收参数-start*/
                {
                    id:id                 //用户ID
                },
