...
var api = {
    ...
    * */
    ...
    //抽奖
    prize: function (score) {
        return new Promise(function (resolve, reject) {
            $.post(api.baseUrl + '/x200928/prize',
                function (res) {
                    api.debug && console.log(res);
                    resolve(res);
                });
    ...
    //发红包
    redPack: function (v_code) {
        return new Promise(function (resolve, reject) {
            $.post(api.baseUrl + '/x200928/red_pack',
                /*接收参数-start*/
                {
                    v_code: v_code    //验证码
                },
