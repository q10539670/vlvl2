...
var api = {
    ...
    * */
     ...
     * 提交地区
     */
    area: function (virtual_address_code) {
        return new Promise(function (resolve, reject) {
            $.post(api.baseUrl + '/x191212/area',
                /*接收参数-start*/
                {
                    virtual_address_code: virtual_address_code,   //区域编码
                },
                /*接收参数-end*/
                function (res) {
                    api.debug && console.log(res);
    ...
    location: function (data) {
        return new Promise(function (resolve, reject) {
            $.post(api.baseUrl + '/x191212/location',
                /*接收参数-start*/
                {
                    latitude: data.latitude,              //经度
                    longitude:data.longitude              //纬度
                },
                /*接收参数-end*/
                function (res) {
                    api.debug && console.log(res);
    ...
    prize: function () {
        return new Promise(function (resolve, reject) {
            $.post(api.baseUrl + '/x191212/prize',
                function (res) {
                    api.debug && console.log(res);
                    resolve(res);
                });
