...
var api = {
    ...
    * */
     ...
     * 答题
     */
    topic: function (topic_num) {
        return new Promise(function (resolve, reject) {
            $.post(api.baseUrl + '/x210111/topic',
                /*接收参数-start*/
                {
                    'topic_num': topic_num         //答题数量
                },
                /*接收参数-end*/
                function (res) {
                    api.debug && console.log(res);
    ...
    prize: function () {
        return new Promise(function (resolve, reject) {
            $.post(api.baseUrl + '/x210111/prize',
                function (res) {
                    api.debug && console.log(res);
                    resolve(res);
                });
