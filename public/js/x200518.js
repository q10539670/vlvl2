...
var api = {
    ...
    * */
    ...
    score: function (data) {
        return new Promise(function (resolve, reject) {
            $.post(api.baseUrl + '/X200518/score',
                /*接收参数-start*/
                {
                    score: data.score,       //成绩
                    map: data.map            //地图
    ...
    ranking: function () {
        return new Promise(function (resolve, reject) {
            $.get(api.baseUrl + '/X200518/ranking',
                function (res) {
                    api.debug && console.log(res);
                    resolve(res);
                });
