...
var api = {
    ...
    * */
    ...
    reserve: function (data) {
        return new Promise(function (resolve, reject) {
            $.post(api.baseUrl + '/x201013a/reserve',
                /*接收参数-start*/
                {
                    name: data.name,                    //姓名:徐其阳
                    phone: data.phone,                  //电话:18107120122
                    num: data.num,                      //预约人数:2
                    reserve_date: data.reserve_date,    //预约日期:2020-10-15
                    reserve_time: data.reserve_time     //预约时间:14
                },
                /*接收参数-end*/
                function (res) {
                    api.debug && console.log(res);
