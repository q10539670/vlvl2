...
var api = {
    ...
    * */
     ...
     * 砍价
     */
    help: function (target_user_id) {
        return new Promise(function (resolve, reject) {
            $.post(api.baseUrl + '/x200413/help',
                {
