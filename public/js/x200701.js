...
var api = {
    ...
    * */
    ...
    prize: function () {
        return new Promise(function (resolve, reject) {
            $.post(api.baseUrl + '/x200701/prize',
                function (res) {
                    api.debug && console.log(res);
                    resolve(res);
                });
    ...
    images: function (data) {
        ...
        return new Promise(function (resolve, reject) {
            $.ajax({
                url: api.baseUrl + '/x200701/images',
                type: "post",
                data: formData,
                processData: false,
                contentType: false,
    ...
    uploadLog: function () {
        return new Promise(function (resolve, reject) {
            $.get(api.baseUrl + '/x200701/log_upload',
                function (res) {
                    api.debug && console.log(res);
                    resolve(res);
                });
    ...
    prizeLog: function () {
        return new Promise(function (resolve, reject) {
            $.get(api.baseUrl + '/x200701/log_prize',
                function (res) {
                    api.debug && console.log(res);
                    resolve(res);
                });
