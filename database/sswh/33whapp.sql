...
CREATE TABLE x201013_title
(
    id         INT UNSIGNED AUTO_INCREMENT,
    user_id    INT         NOT NULL DEFAULT 0 COMMENT '用户ID',
    title      VARCHAR(32) NOT NULL DEFAULT '' COMMENT '书名',
    status     TINYINT(1)  NOT NULL DEFAULT 0 COMMENT '状态[0:未审核,1:通过,2:隐藏]',
    created_at DATETIME    NULL     DEFAULT NULL,
    updated_at DATETIME    NULL     DEFAULT NULL,
    PRIMARY KEY (id)
) ENGINE = INNODB
...
-- 百事
CREATE TABLE x201013a_user
(
    id         INT UNSIGNED AUTO_INCREMENT,
    openid     VARCHAR(36)  NOT NULL DEFAULT '',
    nickname   VARCHAR(64)  NOT NULL DEFAULT '' COMMENT '昵称',
    avatar     VARCHAR(255) NOT NULL DEFAULT '' COMMENT '头像',
    num_today  TINYINT(1)   NOT NULL DEFAULT 0 COMMENT '当天预约次数',
    num_total  TINYINT(1)   NOT NULL DEFAULT 0 COMMENT '总预约次数',
    created_at DATETIME     NULL     DEFAULT NULL,
    updated_at DATETIME     NULL     DEFAULT NULL,
    PRIMARY KEY (id)
) ENGINE = INNODB
...
CREATE TABLE x201013a_reserve
(
    id           INT UNSIGNED AUTO_INCREMENT,
    user_id      INT         NOT NULL DEFAULT 0 COMMENT '用户ID',
    name         VARCHAR(16) NOT NULL DEFAULT '' COMMENT '姓名',
    phone        VARCHAR(11) NOT NULL DEFAULT '' COMMENT '电话',
    num          TINYINT(1)  NOT NULL DEFAULT 0 COMMENT '预约人数',
    reserve_date DATE        NULL     DEFAULT NULL COMMENT '预约日期',
    reserve_time TINYINT(1)  NOT NULL DEFAULT 0 COMMENT '预约时间',
    created_at   DATETIME    NULL     DEFAULT NULL,
    updated_at   DATETIME    NULL     DEFAULT NULL,
    PRIMARY KEY (id)
) ENGINE = INNODB
...
(
    ...
    status     INT(1)       NOT NULL DEFAULT 0 COMMENT '状态[0:未抽奖,1:已中奖,2:未中奖,3:确认奖品]',
    prized_at  DATETIME     NULL     DEFAULT NULL COMMENT '中奖时间',
    created_at DATETIME     NULL     DEFAULT NULL,
    updated_at DATETIME     NULL     DEFAULT NULL,
    PRIMARY KEY (id)
