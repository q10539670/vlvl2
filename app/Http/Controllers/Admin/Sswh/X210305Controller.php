...
use App\Exports\X210305Export;
use App\Http\Controllers\Common\BaseV1Controller as Controller;
use App\Models\Sswh\X210305\User;
use Illuminate\Http\Request;
use Maatwebsite\Excel\Facades\Excel;

class X210305Controller extends Controller
{
    public function index(Request $request)
    {
        ...
        $total = User::count();
        $exportUrl = asset('/vlvl/x210305/export');
        $redis = app('redis');
        $redis->select(0);
        $redisShareData = $redis->hGetAll('wx:view:tlc210306');
        return view('sswh.sswhAdmin.x210305', [
            'total' => $total,
            'title' => '中国中铁·世纪山水·天麓城',
            'paginator' => $paginator,
            'exportUrl' => $exportUrl,
    ...
    {
        return Excel::download(new X210305Export, '中国中铁·世纪山水·天麓城·照片.xlsx');
    }
