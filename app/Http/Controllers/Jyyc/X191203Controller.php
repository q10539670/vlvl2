...
class X191203Controller extends Common
{

    protected $itemName = 'x191203';

    const OPEN_SEND_REDPACK = false;  //红包开关
    const END_TIME = '2019-12-12 23:59:59';  //结束时间
    ...
    public function randomPrize(Request $request)
    {
        ...
        $user->save();
        return Helper::json(1, '抽奖成功', ['user' => $user,'resultPrize'=>$resultPrize['resultPrize'],'allPrize'=>$resultPrize]);
    }
