...
class X201029Controller extends Common
{
    //中国中铁·世纪山水---接积木游戏
    protected $itemName = 'x201029';

    const END_TIME = '2020-11-01 23:59:59';
    ...
    public function list(Request $request)
    {
        ...
        $ranking = -1;
        $items = User::where($where)->orderBy('score', 'asc')->orderBy('updated_at',
            'asc')->take(50)->get()->toArray();
