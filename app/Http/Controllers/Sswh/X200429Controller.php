...
class X200429Controller extends Common
{

    //中国中铁·金桥璟园答题领红包
    protected $itemName = 'x200429';

    //红包开关
    const OPEN_SEND_REDPACK = false;
    const END_TIME = '2020-05-01 20:10:59';  //活动截止时间
    const START_TIME = '2020-05-01 20:00:00';  //活动开始时间
    ...
    public function randomPrize(Request $request)
    {
        ...
        if ($timeStr > '2020-05-01 20:00:00') {
            $timeStr = 'gold';
        } else {
            $timeStr = 'test';
        }
