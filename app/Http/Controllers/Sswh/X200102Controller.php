...
{
    //龙湖抽奖
    protected $itemName = 'x200102a';

    const END_TIME = '2020-01-09 23:59:59';
    ...
    public function appInitHandler()
    {
        ...
        $redis->select(12);
        $dataArr = [
            'test', '20200103', '20200104', '20200105', '20200106', '20200107', '20200108', '20200109'
        ];
...
//            }
        ...
        foreach ($dataArr as $k => $v) {
            $redis->hmset('wx:' . $this->itemName . ':prizeCount:' . $v, ['0' => 0, '1' => 0, '2' => 0, '3' => 0]);
        }
        echo '应用初始化成功';
        exit();
    }
