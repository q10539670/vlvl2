...
use App\Models\Sswh\X201208\VoteLog;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class X201208Controller extends Common
{
    //东湖金茂府
    protected $itemName = 'x201208';

    const SUBMIT_TIME = '2020-12-17 23:59:59';
    const START_TIME  = '2020-11-12 00:00:00';
    const END_TIME    = '2020-12-18 23:59:59';
