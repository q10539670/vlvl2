...
use App\Models\Sswh\X200514\User;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class X200514Controller extends Common
{

    //中国中铁·金桥璟园答题领红包
    protected $itemName = 'x200514';

    //红包开关
    const OPEN_SEND_REDPACK = false;
    const END_TIME = '2020-05-15 20:10:59';  //活动截止时间
    const START_TIME = '2020-05-15 20:00:00';  //活动开始时间
    ...
    public function randomPrize(Request $request)
    {
        ...
        if ($timeStr > '2020-05-15 20:00:00') {
            $timeStr = 'gold';
        } else {
            $timeStr = 'test';
        }
