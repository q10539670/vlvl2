...
namespace App\Models\Jyyc\X191225a;
...
//        $openid = 'oFyNdv73iU0nqkMvaaPiB-VBBLdc';
        $orderNum = 'jyyc191225a' . date('His') . 'aa' . $user_id . 'aa' . mt_rand(1, 10);
        $config = [
...
//            'client_ip'    => '192.168.0.1',  //可不传，不传则由 SDK 取当前客户端 IP
    ...
    * */
    ...
    protected $prizeConf = [
        /*中奖数组*/
        'prize' => [
            0 => ['prize_id' => 1, 'prize_level_name' => '一等奖', 'prize_name' => '66元红包', 'money' => 66, 'v' => 1, 'count' => 0, 'limit' => 10],
            1 => ['prize_id' => 2, 'prize_level_name' => '二等奖', 'prize_name' => '8.8元红包', 'money' => 8.8, 'v' => 10, 'count' => 0, 'limit' => 100],
            2 => ['prize_id' => 3, 'prize_level_name' => '三等奖', 'prize_name' => '6.6元红包', 'money' => 6.6, 'v' => 20, 'count' => 0, 'limit' => 200],
            3 => ['prize_id' => 4, 'prize_level_name' => '四等奖', 'prize_name' => '5.8元红包', 'money' => 5.8, 'v' => 10, 'count' => 0, 'limit' => 100],
            4 => ['prize_id' => 5, 'prize_level_name' => '五等奖', 'prize_name' => '2.8元红包', 'money' => 2.8, 'v' => 10, 'count' => 0, 'limit' => 100],
