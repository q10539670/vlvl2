...
namespace App\Models\Jyyc\X200325;
...
class Code extends Model
{
    ...
    public static function getUniqueCode($len)
    {
        ...
        if (!self::where('code', $randomCode)->first()) {
           return Code::create(['code'=>$randomCode]);
        }
...
//        $openid = 'oFyNdv73iU0nqkMvaaPiB-VBBLdc';
        $orderNum = 'jyyc200325' . date('His') . 'aa' . $user_id . 'aa' . mt_rand(1, 10);
        $config = [
...
//            'client_ip'    => '192.168.0.1',  //可不传，不传则由 SDK 取当前客户端 IP
    ...
    * */
    ...
    protected $prizeConf = [
        /*中奖数组*/
        'prize' => [
            0 => ['prize_id' => 1, 'prize_level_name' => '六等奖', 'prize_name' => '8.80元红包',  'money' => 8.80, 'v' => 42, 'count' => 0, 'limit' => 42],
            1 => ['prize_id' => 2, 'prize_level_name' => '五等奖', 'prize_name' => '9.90元红包',  'money' => 9.90, 'v' => 7, 'count' => 0, 'limit' => 7],
            2 => ['prize_id' => 3, 'prize_level_name' => '四等奖', 'prize_name' => '18.8元红包',  'money' => 18.8, 'v' => 2, 'count' => 0, 'limit' => 2],
            3 => ['prize_id' => 4, 'prize_level_name' => '三等奖', 'prize_name' => '28.8元红包',  'money' => 28.8, 'v' => 2, 'count' => 0, 'limit' => 2],
            4 => ['prize_id' => 5, 'prize_level_name' => '二等奖', 'prize_name' => '66.0元红包',  'money' => 66.0, 'v' => 1, 'count' => 0, 'limit' => 1],
            5 => ['prize_id' => 6, 'prize_level_name' => '一等奖', 'prize_name' => '666元红包',   'money' => 666,  'v' => 1, 'count' => 0, 'limit' => 1],
//            4 => ['prize_id' => 5, 'prize_level_name' => '五等奖', 'prize_name' => '1元红包', 'money' => 1, 'v' => 10, 'count' => 0, 'limit' => 10],
        ],
        /*不中奖   --未中奖*/
