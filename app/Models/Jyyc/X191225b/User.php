...
namespace App\Models\Jyyc\X191225b;
...
//        $openid = 'oFyNdv73iU0nqkMvaaPiB-VBBLdc';
        $orderNum = 'jyyc191225b' . date('His') . 'aa' . $user_id . 'aa' . mt_rand(1, 10);
        $config = [
...
//            'client_ip'    => '192.168.0.1',  //可不传，不传则由 SDK 取当前客户端 IP
    ...
    * */
    ...
    protected $prizeConf = [
        /*中奖数组*/
        'prize' => [
            0 => ['prize_id' => 1, 'prize_level_name' => '一等奖', 'prize_name' => '666元红包', 'money' => 666, 'v' => 2, 'count' => 0, 'limit' => 2],
            1 => ['prize_id' => 2, 'prize_level_name' => '二等奖', 'prize_name' => '188元红包', 'money' => 188, 'v' => 10, 'count' => 0, 'limit' => 10],
            2 => ['prize_id' => 3, 'prize_level_name' => '三等奖', 'prize_name' => '88元红包', 'money' => 88, 'v' => 15, 'count' => 0, 'limit' => 15],
        ],
        /*不中奖   --未中奖*/
