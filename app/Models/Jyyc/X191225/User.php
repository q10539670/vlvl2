...
namespace App\Models\Jyyc\X191225;
...
//        $openid = 'oFyNdv73iU0nqkMvaaPiB-VBBLdc';
        $orderNum = 'jyyc191225' . date('His') . 'aa' . $user_id . 'aa' . mt_rand(1, 10);
        $config = [
...
//            'client_ip'    => '192.168.0.1',  //可不传，不传则由 SDK 取当前客户端 IP
    ...
    protected function getResultTest()
    {
        $successStr = '{
            ...
            "err_code": "SUCCESS",
            "err_code_des": "发放成功",
            "mch_billno": "jyyc191225184118aa9aa10",
            "mch_id": "1493373832",
    ...
    * */
    ...
    protected $prizeConf = [
        /*中奖数组*/
        'prize' => [
            0 => ['prize_id' => 1, 'prize_level_name' => '一等奖', 'prize_name' => '188元红包', 'money' => 188, 'v' => 1, 'count' => 0, 'limit' => 1],
            1 => ['prize_id' => 2, 'prize_level_name' => '二等奖', 'prize_name' => '88元红包', 'money' => 88, 'v' => 2, 'count' => 0, 'limit' => 2],
            2 => ['prize_id' => 3, 'prize_level_name' => '三等奖', 'prize_name' => '66元红包', 'money' => 66, 'v' => 2, 'count' => 0, 'limit' => 2],
            3 => ['prize_id' => 4, 'prize_level_name' => '四等奖', 'prize_name' => '8.8元红包', 'money' => 8.8, 'v' => 150, 'count' => 0, 'limit' => 150],
            4 => ['prize_id' => 5, 'prize_level_name' => '五等奖', 'prize_name' => '6.6元红包', 'money' => 6.6, 'v' => 300, 'count' => 0, 'limit' => 300],
