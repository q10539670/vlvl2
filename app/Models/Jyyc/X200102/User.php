...
namespace App\Models\Jyyc\X200102;
...
//        $openid = 'oFyNdv73iU0nqkMvaaPiB-VBBLdc';
        $orderNum = 'jyyc200110' . date('His') . 'aa' . $user_id . 'aa' . mt_rand(1, 10);
        $config = [
...
//            'client_ip'    => '192.168.0.1',  //可不传，不传则由 SDK 取当前客户端 IP
    ...
    * */
    ...
    protected $prizeConf = [
        /*中奖数组*/
        'prize' => [
            0 => ['prize_id' => 1, 'prize_level_name' => '一等奖', 'prize_name' => '66元红包', 'money' => 66, 'v' => 5, 'count' => 0, 'limit' => 5],
            1 => ['prize_id' => 2, 'prize_level_name' => '二等奖', 'prize_name' => '8.8元红包', 'money' => 8.8, 'v' => 100, 'count' => 0, 'limit' => 100],
            2 => ['prize_id' => 3, 'prize_level_name' => '三等奖', 'prize_name' => '6.6元红包', 'money' => 6.6, 'v' => 200, 'count' => 0, 'limit' => 200],
            3 => ['prize_id' => 4, 'prize_level_name' => '四等奖', 'prize_name' => '5.8元红包', 'money' => 5.8, 'v' => 100, 'count' => 0, 'limit' => 100],
            4 => ['prize_id' => 5, 'prize_level_name' => '五等奖', 'prize_name' => '2.8元红包', 'money' => 2.8, 'v' => 100, 'count' => 0, 'limit' => 100],
            5 => ['prize_id' => 6, 'prize_level_name' => '六等奖', 'prize_name' => '1.8元红包', 'money' => 1.8, 'v' => 700, 'count' => 0, 'limit' => 700],
            6 => ['prize_id' => 7, 'prize_level_name' => '七等奖', 'prize_name' => '1元红包', 'money' => 1, 'v' => 300, 'count' => 0, 'limit' => 300],
//            4 => ['prize_id' => 5, 'prize_level_name' => '五等奖', 'prize_name' => '1元红包', 'money' => 1, 'v' => 300, 'count' => 0, 'limit' => 10],      //测试
        ],
        /*不中奖   --未中奖*/
