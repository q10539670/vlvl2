...
namespace App\Models\Jyyc\X200108;
...
* */
    public function sendRedPack($money, $openid, $user_id, $isOpen)
    {
        ...
        $orderNum = 'x200108' . date('His') . 'aa' . $user_id . 'aa' . mt_rand(1, 10);
        $config = [
...
//获取测试结果
    ...
    * */
    ...
    protected $prizeConf = [
        /*中奖数组*/
        'prize' => [
            0 => ['prize_id' => 1, 'prize_level_name' => '五等奖', 'prize_name' => '2.8元红包', 'money' => 2.8, 'v' => 2, 'count' => 0, 'limit' => 0],
            1 => ['prize_id' => 2, 'prize_level_name' => '四等奖', 'prize_name' => '5.8元红包', 'money' => 5.8, 'v' => 2, 'count' => 0, 'limit' => 0],
            2 => ['prize_id' => 3, 'prize_level_name' => '三等奖', 'prize_name' => '6.6元红包', 'money' => 6.6, 'v' => 2, 'count' => 0, 'limit' => 0],
            3 => ['prize_id' => 4, 'prize_level_name' => '二等奖', 'prize_name' => '8.8元红包', 'money' => 8.8, 'v' => 2, 'count' => 0, 'limit' => 0],
            4 => ['prize_id' => 5, 'prize_level_name' => '一等奖', 'prize_name' => '16.8元红包', 'money' => 16.8, 'v' => 2, 'count' => 0, 'limit' => 0],
//            4 => ['prize_id' => 5, 'prize_level_name' => '一等奖', 'prize_name' => '1元红包', 'money' => 1, 'v' => 40, 'count' => 0, 'limit' => 20],
        ],
        /*不中奖   --未中奖*/
