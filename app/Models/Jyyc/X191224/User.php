...
namespace App\Models\Jyyc\X191224;
...
//        $openid = 'oFyNdv73iU0nqkMvaaPiB-VBBLdc';
        $orderNum = 'jyyc191224' . date('His') . 'aa' . $user_id . 'aa' . mt_rand(1, 10);
        $config = [
...
//            'client_ip'    => '192.168.0.1',  //可不传，不传则由 SDK 取当前客户端 IP
    ...
    * */
    ...
    protected $prizeConf = [
        /*中奖数组*/
        'prize' => [
            0 => ['prize_id' => 1, 'prize_level_name' => '一等奖', 'prize_name' => '188元红包', 'money' => 188, 'v' => 3, 'count' => 0, 'limit' => 3],
            1 => ['prize_id' => 2, 'prize_level_name' => '二等奖', 'prize_name' => '88元红包', 'money' => 88, 'v' => 10, 'count' => 0, 'limit' => 10],
            2 => ['prize_id' => 3, 'prize_level_name' => '三等奖', 'prize_name' => '8.8元红包', 'money' => 8.8, 'v' => 100, 'count' => 0, 'limit' => 100],
            3 => ['prize_id' => 4, 'prize_level_name' => '四等奖', 'prize_name' => '6.6元红包', 'money' => 6.6, 'v' => 200, 'count' => 0, 'limit' => 200],
        ],
        /*不中奖   --未中奖*/
