...
namespace App\Models\Jyyc\X191203;
...
//        $openid = 'oFyNdv73iU0nqkMvaaPiB-VBBLdc';
        $orderNum = 'jyyc191203' . date('His') . 'aa' . $user_id . 'aa' . mt_rand(1, 10);
        $config = [
...
//            'client_ip'    => '192.168.0.1',  //可不传，不传则由 SDK 取当前客户端 IP
    ...
    * #######################################################################################################################################################
    * */
    private $zhongJiangLv = 0.605;  //设置中奖率 如果大于 1 始终会转化为0~1之间的小数
    ...
    protected $prizeConf = [
        /*中奖数组*/
        'prize' => [
            0 => ['prize_id' => 1, 'prize_level_name' => '一等奖', 'prize_name' => '88元红包', 'money' => 88, 'v' => 1, 'count' => 0, 'limit' => 2],
            1 => ['prize_id' => 2, 'prize_level_name' => '二等奖', 'prize_name' => '66元红包', 'money' => 66, 'v' => 4, 'count' => 0, 'limit' => 4],
            2 => ['prize_id' => 3, 'prize_level_name' => '三等奖', 'prize_name' => '3.88元红包', 'money' => 3.88, 'v' => 5, 'count' => 0, 'limit' => 5],
            3 => ['prize_id' => 4, 'prize_level_name' => '四等奖', 'prize_name' => '2.88元红包', 'money' => 2.88, 'v' => 20, 'count' => 0, 'limit' => 20],
            4 => ['prize_id' => 5, 'prize_level_name' => '五等奖', 'prize_name' => '1.88元红包', 'money' => 1.88, 'v' => 210, 'count' => 0, 'limit' => 210],
