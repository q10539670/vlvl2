...
namespace App\Models\Jctj\X191028;

use Illuminate\Database\Eloquent\Model;

class User extends Model
{
    protected $table = 'x191028_user';
    ...
    * */
    ...
    protected $prizeConf = [
        /*中奖数组*/
        'prize' => [
            0 => ['prize_id' => 1, 'prize_level_name' => '一等奖', 'prize_name' => '口红', 'v' => 0, 'count' => 0, 'limit' => 5],
            1 => ['prize_id' => 2, 'prize_level_name' => '二等奖', 'prize_name' => '丝巾', 'v' => 10, 'count' => 0, 'limit' => 10],
            2 => ['prize_id' => 3, 'prize_level_name' => '三等奖', 'prize_name' => '龙小湖', 'v' => 15, 'count' => 0, 'limit' => 15],
        ],
