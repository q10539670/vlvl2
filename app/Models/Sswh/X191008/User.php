...
namespace App\Models\Sswh\X191008;

use Illuminate\Database\Eloquent\Model;

class User extends Model
{
    protected $table = 'x191008_user';
    ...
    public function getUser($ids)
    {
        ...
        $user = User::where('ticket', 2)->where('status',1)->whereNotIn('id', $ids)->offset($random)->limit(1)->get()->toArray();
        return $user[0];
    }
