...
namespace App\Models\Sswh\X200512;

use Illuminate\Database\Eloquent\Model;

class User extends Model
{
    protected $table = 'x200512_user';
    ...
    * */
    ...
    protected $prizeConf = [
        /*中奖数组*/
        'prize' => [
            0 => ['prize_id' => 1, 'prize_level_name' => '一等奖', 'prize_name' => '精美礼物', 'v' => 1, 'count' => 0, 'limit' => 0],
        ],
        /*不中奖   --未中奖*/
    ...
    {
        if (!in_array($dateStr, ['20200525', '20200526', '20200527', '20200528', '20200529', '20200530', '20200531', '20200601', '20200602'])) {
            $dateStr = 'test';
        }
