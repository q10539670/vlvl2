...
namespace App\Models\Sswh\X200102;

use Illuminate\Database\Eloquent\Model;

class User extends Model
{
    protected $table = 'x200102a_user';
    ...
    * #######################################################################################################################################################
    * */
    private $zhongJiangLv = 0.08;  //设置中奖率 如果大于 1 始终会转化为0~1之间的小数
    ...
    protected $prizeConf = [
        /*中奖数组*/
        'prize' => [
            0 => ['prize_id' => 1, 'prize_level_name' => '一等奖', 'prize_name' => '一等奖', 'v' => 1, 'count' => 0, 'limit' => 0],
            1 => ['prize_id' => 2, 'prize_level_name' => '二等奖', 'prize_name' => '二等奖', 'v' => 3, 'count' => 0, 'limit' => 0],
            2 => ['prize_id' => 3, 'prize_level_name' => '三等奖', 'prize_name' => '三等奖', 'v' => 5, 'count' => 0, 'limit' => 0],
        ],
        /*不中奖   --未中奖*/
    ...
    {
        if (!in_array($dateStr, ['20200103', '20200104', '20200105', '20200106', '20200107', '20200108', '20200109'])) {
            $dateStr = 'test';
        }
