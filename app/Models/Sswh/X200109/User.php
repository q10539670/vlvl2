...
namespace App\Models\Sswh\X200109;

use Illuminate\Database\Eloquent\Model;

class User extends Model
{
    protected $table = 'x200109_user';
    ...
    * */
    ...
    protected $prizeConf = [
        /*中奖数组*/
        'prize' => [
            0 => ['prize_id' => 1, 'prize_level_name' => '一等奖', 'prize_name' => '美年达瓶型U盘', 'v' => 1, 'count' => 0, 'limit' => 0],
        ],
        /*不中奖   --未中奖*/
    ...
    {
        if (!in_array($dateStr, ['20200115', '20200116', '20200117', '20200114'])) {
            $dateStr = 'test';
        }
