...
namespace App\Models\Sswh\X200117;

use Illuminate\Database\Eloquent\Model;

class User extends Model
{
    protected $table = 'x200117_user';
    ...
    * */
    ...
    protected $prizeConf = [
        /*中奖数组*/
        'prize' => [
            0 => ['prize_id' => 1, 'prize_level_name' => '一等奖', 'prize_name' => '一等奖', 'v' => 3, 'count' => 0, 'limit' => 3],
            1 => ['prize_id' => 2, 'prize_level_name' => '二等奖', 'prize_name' => '二等奖', 'v' => 10, 'count' => 0, 'limit' => 10],
            2 => ['prize_id' => 3, 'prize_level_name' => '三等奖', 'prize_name' => '三等奖', 'v' => 20, 'count' => 0, 'limit' => 20],
        ],
        /*不中奖   --未中奖*/
