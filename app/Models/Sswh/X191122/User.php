...
namespace App\Models\Sswh\X191122;

use Illuminate\Database\Eloquent\Model;

class User extends Model
{
    protected $table = 'x191122_user';
    ...
    * */
    ...
    protected $prizeConf = [
        /*中奖数组*/
        'prize' => [
            0 => ['prize_id' => 1, 'prize_level_name' => '一等奖', 'prize_name' => '变温杯', 'v' => 2, 'count' => 0, 'limit' => 5],
            1 => ['prize_id' => 2, 'prize_level_name' => '二等奖', 'prize_name' => 'U盘', 'v' => 2, 'count' => 0, 'limit' => 5],
            2 => ['prize_id' => 3, 'prize_level_name' => '三等奖', 'prize_name' => '百事代言人海报', 'v' => 15, 'count' => 0, 'limit' => 10],
        ],
