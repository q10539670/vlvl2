...
namespace App\Models\Sswh\X200312;
...
class User extends Model
{
    ...
    public function sendRedPack($money, $openid, $user_id, $isOpen)
    {
        ...
        $orderNum = 'x200312' . date('His') . 'aa' . $user_id . 'aa' . mt_rand(1, 10);
        $config = [
...
//获取测试结果
    ...
    * */
    ...
    protected $prizeConf = [
        /*中奖数组*/
        'prize' => [
            0 => ['prize_id' => 1, 'prize_level_name' => '七等奖', 'prize_name' => '1.08元红包',    'money' => 1.08,   'v' => 600, 'count' => 0, 'limit' => 0],
            1 => ['prize_id' => 2, 'prize_level_name' => '六等奖', 'prize_name' => '1.80元红包',    'money' => 1.80,   'v' => 300, 'count' => 0, 'limit' => 0],
            2 => ['prize_id' => 3, 'prize_level_name' => '五等奖', 'prize_name' => '2.80元红包',    'money' => 2.80,   'v' => 100, 'count' => 0, 'limit' => 0],
            3 => ['prize_id' => 4, 'prize_level_name' => '四等奖', 'prize_name' => '8.80元红包',    'money' => 8.80,   'v' => 50, 'count' => 0,  'limit' => 0],
            4 => ['prize_id' => 5, 'prize_level_name' => '三等奖', 'prize_name' => '18.80元红包',   'money' => 18.80,  'v' => 30, 'count' => 0,  'limit' => 0],
            5 => ['prize_id' => 6, 'prize_level_name' => '二等奖', 'prize_name' => '88.80元红包',   'money' => 88.80,  'v' => 3, 'count' => 0,   'limit' => 0],
            6 => ['prize_id' => 7, 'prize_level_name' => '一等奖', 'prize_name' => '188.80元红包',  'money' => 188.80, 'v' => 1, 'count' => 0,   'limit' => 0],
//            1 => ['prize_id' => 1, 'prize_level_name' => '一等奖', 'prize_name' => '1元红包', 'money' => 1, 'v' => 40, 'count' => 0, 'limit' => 20],
        ],
        /*不中奖   --未中奖*/
    ...
    protected $prizeConfLimit = [
        ...
        'gold' => [
            '1' =>  ['prize_id' => 1,  'limit' => 600],
            '2' =>  ['prize_id' => 2,  'limit' => 300],
            '3' =>  ['prize_id' => 3,  'limit' => 100],
