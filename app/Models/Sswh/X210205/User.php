...
namespace App\Models\Sswh\X210205;
...
class User extends Model
{
    ...
    public function sendRedPack($money, $openid, $user_id, $isOpen)
    {
        ...
        $orderNum = 'x210205' . date('His') . 'aa' . $user_id . 'aa' . mt_rand(1, 10);
        $config = [
...
//        }
    ...
    * */
    ...
    protected $prizeConf = [
        /*中奖数组*/
        'prize' => [
            0 => ['prize_id' => 1, 'prize_level_name' => '六等奖', 'prize_name' => '果岭推杆体验券',    'money' => 0,   'v' => 25, 'count' => 0, 'limit' => 0],
            1 => ['prize_id' => 2, 'prize_level_name' => '五等奖', 'prize_name' => '恒温游泳池体验券',    'money' => 0,   'v' => 25, 'count' => 0, 'limit' => 0],
            2 => ['prize_id' => 3, 'prize_level_name' => '四等奖', 'prize_name' => '游艇观湖体验券',    'money' => 0,   'v' => 25, 'count' => 0, 'limit' => 0],
            3 => ['prize_id' => 4, 'prize_level_name' => '三等奖', 'prize_name' => '1.08元现金红包',    'money' => 1.08,   'v' => 10, 'count' => 0, 'limit' => 0],
            4 => ['prize_id' => 5, 'prize_level_name' => '二等奖', 'prize_name' => '1.18元现金红包',    'money' => 1.18,   'v' => 10, 'count' => 0, 'limit' => 0],
            5 => ['prize_id' => 6, 'prize_level_name' => '一等奖', 'prize_name' => '2.18元现金红包',    'money' => 2.18,   'v' => 5, 'count' => 0, 'limit' => 0],
//            3 => ['prize_id' => 4, 'prize_level_name' => '测试', 'prize_name' => '1元红包', 'money' => 1, 'v' => 10000000, 'count' => 0, 'limit' => 0],
        ],
        /*不中奖   --未中奖*/
    ...
    protected $prizeConfLimit = [
        ...
        'gold' => [
            '1' =>  ['prize_id' => 1,  'limit' => 100000],
            '2' =>  ['prize_id' => 2,  'limit' => 100000],
            '3' =>  ['prize_id' => 3,  'limit' => 100000],
            '4' =>  ['prize_id' => 4,  'limit' => 800],
            '5' =>  ['prize_id' => 5,  'limit' => 600],
            '6' =>  ['prize_id' => 6,  'limit' => 600],
            '20' => ['prize_id' => 20, 'limit' => 100000],
            '21' => ['prize_id' => 21, 'limit' => 100000],
            '22' => ['prize_id' => 22, 'limit' => 100000],
        ]
