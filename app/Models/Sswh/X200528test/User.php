...
namespace App\Models\Sswh\X200528test;

use Illuminate\Database\Eloquent\Model;

class User extends Model
{
    protected $table = 'x200528_user_test';
    ...
    * */
    ...
    protected $prizeConf = [
        /*中奖数组*/
        'prize' => [
            0 => ['prize_id' => 1, 'prize_level_name' => '三等奖', 'prize_name' => '小黄人彩盒套装', 'money' => 1, 'v' => 160, 'count' => 0, 'limit' => 0],
            1 => ['prize_id' => 2, 'prize_level_name' => '二等奖', 'prize_name' => '定制兔儿杯', 'money' => 10, 'v' => 70, 'count' => 0, 'limit' => 0],
            2 => ['prize_id' => 3, 'prize_level_name' => '一等奖', 'prize_name' => '暖心大白台灯', 'money' => 50, 'v' => 70, 'count' => 0, 'limit' => 0],
        ],
        /*不中奖   --未中奖*/
    ...
    protected $prizeConfLimit = [
        ...
        'gold' => [
            '1' => ['prize_id' => 1, 'limit' => 160],
            '2' => ['prize_id' => 2, 'limit' => 70],
            '3' => ['prize_id' => 3, 'limit' => 70],
            '0' => ['prize_id' => 0, 'limit' => 100000]
        ]
    ];
