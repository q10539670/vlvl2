...
namespace App\Models\Qwt\X191119;
...
//        $openid = 'oFyNdv73iU0nqkMvaaPiB-VBBLdc';
        $orderNum = 'qwt191119' . date('His') . 'aa' . $user_id . 'aa' . mt_rand(1, 10);
        $config = [
...
//            'client_ip'    => '192.168.0.1',  //可不传，不传则由 SDK 取当前客户端 IP
    ...
    {
        if (!in_array($dateStr, ['20191122', '20191123', '20191124'])) {
            $dateStr = 'test';
        }
        $hubeiOrQuanguo = null;
