...
use App\Exports\Qwt\X191022\X191022Export;
use App\Models\Qwt\X191022\UserZzz;
use Illuminate\Console\Command;
use Maatwebsite\Excel\Facades\Excel;
use App\Models\Qwt\X191022\User;

class X191022 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'x191022:cmd {handle?}';
     ...
     * @var stringapp
     */
    protected $description = '电信2019年10月';
...
//        $num = 60/$limitSecond-1;
    ...
    protected function exportHander()
    {
        ...
        $res = Excel::store(new X191022Export(), '/excel/' . $this->description . '抽奖名单_共' . $pages . '页.xlsx', $storeDriver);
        if ($res) {
            echo "excel表格导出成功 \n";
            return $res;
        }
