...
class X201201b extends Command
{
    /**
    ...
    public function handle()
    {
        ...
        $result = $this->seedTemplateMsg($openid, $firstMsg, $keyword1, $remark);
//        foreach ($users as $user) {
//            $result = $this->seedTemplateMsg($user->openid, $firstMsg, $keyword1, $remark);
...
//        }
    ...
    public function seedTemplateMsg($openid, $first, $keyword1, $remark)
    {
