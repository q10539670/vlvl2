...
namespace App\Http\Controllers\Ticket\XcxL200506\Service;

use App\Helpers\Helper;
use App\Models\Ticket\XcxL200506\Msg as Msg;
use App\Models\Ticket\XcxL200506\Ticket;
...
class MsgService
{
     ...
     *
     * */
    public function send($openid, Ticket $ticket, $userId, $templateId = '3PU474JAjAn37yHCjH0mPNRaRTYyC2Knqx5sns3zxFw')
    {
        $url = 'https://api.weixin.qq.com/cgi-bin/message/subscribe/send?access_token=' . Helper::getTongYiXcxAccessToken();
