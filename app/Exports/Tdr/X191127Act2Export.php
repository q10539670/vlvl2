...
class X191127Act2Export implements FromCollection, WithStrictNullComparison,WithHeadings,ShouldAutoSize
{
    ...
    */
    ...
    {
        $act2 = Act2::get(['user_id', 'money', 'red_money', 'prize','name','phone','redpack_discribe','created_at']);
