...
$moneyLabel = [
    ...
    0=>'--',
    880=>'<span class="badge bg-teal">8.8</span>',
    8800=>'<span class="badge bg-teal">88</span>',
    18800=>'<span class="badge bg-aqua">188</span>',
    66600=>'<span class="badge bg-yellow">666.00</span>',
];
?>
@section('title', $title)
        ...
        <div class="box-header with-border">
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-2 col-sm-8 col-sm-offset-2">
                    <form class="form-inline" method="get" action="{{url('vlvl/x191225b/index')}}">
