        ...
        <div class="box-header with-border">
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-2 col-sm-8 col-sm-offset-2">
                    <form class="form-inline" method="get" action="{{url('vlvl/x200121/index')}}">
                        {{--                        <div class="form-group">--}}
                        ...
                        <div class="form-group">
                            <select name="order" class="form-control">
                                ...
                                <option {{($statusNow =='0')?'selected':''}}  value="0">按热力值</option>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover dataTable" id="ss-tb">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center;">热力值</th>
                                ...
                                @foreach($paginator as $user)
                                    <tr align="center">
                                        ...
                                        <td>{{$user['words']}}</td>
                                        <th style="text-align: center;">{{$user['love']}}</th>
