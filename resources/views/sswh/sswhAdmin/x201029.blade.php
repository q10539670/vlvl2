        ...
        <div class="box-header with-border">
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-2 col-sm-8 col-sm-offset-2">
                    <form class="form-inline" method="get" action="{{url('vlvl/x201029/index')}}">
                        <div class="form-group">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover dataTable" id="ss-tb">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center;">最佳成绩</th>
                                    <th style="text-align: center;">参与时间</th>
                                    <th style="text-align: center;">成绩时间</th>
                                </tr>
                                </thead>
                                <tbody>
                                @foreach($paginator as $user)
                                    <tr align="center">
                                        ...
                                        <td>
                                            ...
                                            <td align="center">{{$user['score']/100}}</td>
                                            <td align="center">{{$user['created_at']}}</td>
                                            <td align="center">{{$user['ranking_at']}}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                                <tfoot>
