...
$moneyLabel = [
    ...
    280=>'<span class="badge bg-teal">2.80</span>',
    580=>'<span class="badge bg-teal">5.80</span>',
    660=>'<span class="badge bg-teal">6.60</span>',
    880=>'<span class="badge bg-aqua">8.80</span>',
    6600=>'<span class="badge bg-yellow">66.00</span>',
];
?>
@section('title', $title)
        ...
        <div class="box-header with-border">
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-2 col-sm-8 col-sm-offset-2">
                    <form class="form-inline" method="get" action="{{url('vlvl/x200102/index')}}">
