        ...
        <div class="box-header with-border">
            <div class="row">
                ...
                <div class="col-md-5 col-md-offset-2 col-sm-8 col-sm-offset-2">
                    <form class="form-inline" method="get" action="{{url('vlvl/x201204/index')}}">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover dataTable" id="ss-tb">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center;">主料</th>
                                    <th style="text-align: center;">辅料</th>
                                    <th style="text-align: center;">调味品</th>
                                </tr>
                                </thead>
                                <tbody>
                                @foreach($paginator as $user)
                                    <tr align="center">
                                        ...
                                        <td align="center">{{$dishesLabel[$user['dishes']] ?? ''}}</td>
                                        <td align="center">{{ $user['main'] ?'螃蟹'.$user['main'].'只' : ''}}</td>
                                        <td align="center">{{$user['accessories']}}</td>
                                        <td align="center">{{$user['flavoring']}}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                                <tfoot>
