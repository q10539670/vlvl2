        ...
        <div class="box-header with-border">
            <div class="row">
                ...
                <div class="col-md-7 col-md-offset-2 col-sm-8 col-sm-offset-2">
                    <form class="form-inline" method="get" action="{{url('vlvl/x200914/index')}}">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <select name="item_id" class="form-control">
                                ...
                                <option {{($itemNow =='3')?'selected':''}} value="3">华发阳逻金茂逸墅|阳逻金茂逸墅|阳逻金茂悦</option>
                                <option {{($itemNow =='4')?'selected':''}} value="4">武汉国际社区</option>
                            </select>
                        </div>
                        <div class="form-group">
