...
$authLabel = [
    0 => '<span class="badge bg-gary">非业主</span>',
    1 => '<span class="badge bg-teal">业主</span>',
];
?>
@section('title', $title)
        ...
        <div class="box-header with-border">
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-2 col-sm-8 col-sm-offset-2">
                    <form class="form-inline" method="get" action="{{url('vlvl/x191202/index')}}">
                        ...
                        <div class="form-group">
                            <select name="status" class="form-control">
                                ...
                                <option {{($statusNow =='1')?'selected':''}} value="1">已中奖(未领奖)</option>
                                <option {{($statusNow =='2')?'selected':''}} value="2">未中奖</option>
                                <option {{($statusNow =='3')?'selected':''}} value="3">已领奖</option>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover dataTable" id="ss-tb">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center;">是否业主</th>
                                ...
                                @foreach($paginator as $user)
                                    <tr align="center">
                                        ...
                                        <td align="center">{!! $authLabel[$user['auth']] !!}</td>
