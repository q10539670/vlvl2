...
$moneyLabel = [
    ...
    288=>'<span class="badge bg-aqua">2.88</span>',
    388=>'<span class="badge bg-yellow">3.88</span>',
    6600=>'<span class="badge bg-yellow">66.00</span>',
    8800=>'<span class="badge bg-yellow">88.00</span>',
];
?>
@section('title', $title)
        ...
        <div class="box-header with-border">
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-2 col-sm-8 col-sm-offset-2">
                    <form class="form-inline" method="get" action="{{url('vlvl/x191203/index')}}">
