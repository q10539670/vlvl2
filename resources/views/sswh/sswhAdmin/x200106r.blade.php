        ...
        <nav class="navbar navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    <a href="javascript:void(0)" class="navbar-brand"><b>三山文化|宜昌中心·天宸府</b></a>
                </div>
        ...
        <div class="container">
            ...
            <section class="content">
                <div class="alert alert-warning alert-dismissible">
                    ...
                    @else
                        <span id="alert" style="text-align: center">当前为第{{$round}}波抽奖</span>
                    @endif
                        <br><br>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <button type="button" onclick="round(this,1,1)" class="btn btn-block btn-info">第一波</button>
                        <button type="button" onclick="round(this,2,1)" class="btn btn-block btn-info">第二波</button>
                        <button type="button" onclick="round(this,3,1)" class="btn btn-block btn-info">第三波</button>
                        <button type="button" onclick="round(this,4,1)" class="btn btn-block btn-info">第四波</button>
                        <button type="button" onclick="round(this,5,1)" class="btn btn-block btn-info">第五波</button>
...
<script>
    ...
    function round(obj, round,status) {
        ...
        layer.confirm(msg, function () {
            $.ajax({
                url: '{{url('vlvl/api/sswh/x200106r/set_round')}}',
                type: 'post',
                data: {'round': round, 'status':status},
                success: function (res) {
                    if (res == '停止') {
                        layer.msg('停止抽奖');
                        $('#alert').html('当前抽奖未开始');
