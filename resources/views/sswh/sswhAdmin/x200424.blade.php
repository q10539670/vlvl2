...
<?php
$statusLabel = [
    0 => '<span class="badge bg-gary">未中奖</span>',
    1 => '<span class="badge bg-teal">大桥礼包</span>'
];
        ...
        <div class="box-header with-border">
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-2 col-sm-8 col-sm-offset-2">
                    <form class="form-inline" method="get" action="{{url('vlvl/x200424/index')}}">
                        <div class="form-group">
                                ...
                                @foreach($paginator as $user)
                                    <tr align="center">
                                        ...
                                        <td>
                                            ...
                                            <td>{{$user['phone']}}</td>
                                            <td>{{$user['address']}}</td>
                                        <td>{!! $statusLabel[$user['prize_id']] !!}</td>
