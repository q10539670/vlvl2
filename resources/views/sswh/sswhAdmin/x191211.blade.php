...
$moneyLabel = [
    ...
    180=>'<span class="badge bg-teal">1.80</span>',
    280=>'<span class="badge bg-aqua">2.80</span>',
    580=>'<span class="badge bg-yellow">5.80</span>',
    680=>'<span class="badge bg-yellow">6.80</span>',
    880=>'<span class="badge bg-yellow">8.80</span>',
    1880=>'<span class="badge bg-yellow">18.80</span>',
    18800=>'<span class="badge bg-yellow">188</span>',
];
?>
@section('title', $title)
        ...
        <div class="box-header with-border">
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-2 col-sm-8 col-sm-offset-2">
                    <form class="form-inline" method="get" action="{{url('vlvl/x191211/index')}}">
