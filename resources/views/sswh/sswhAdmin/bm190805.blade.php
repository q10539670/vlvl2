        ...
        <div class="box-header with-border">
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-2 col-sm-8 col-sm-offset-2">
                    <form class="form-inline" method="get" action="{{url('vlvl/sswhAdmin/enter')}}">
                        <div class="form-group">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover dataTable" id="ss-tb">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center;">厨龄</th>
                                    <th style="text-align: center;">拿手菜</th>
                                ...
                                @foreach($paginator as $user)
                                    <tr align="center">
                                        ...
                                        <td align="center">{{$sexMap[$user['sex']]}}</td>
                                        <td align="center">{{$user['age']}}</td>
                                        <td align="center">{{$user['cooking_age']}}</td>
