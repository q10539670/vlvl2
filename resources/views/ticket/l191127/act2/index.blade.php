...
@php
    ...
    foreach ($moneys as $money) {
        if ($money == 1) {
            $moneyLabel[$money] = '<span class="badge bg-yellow">华为Mate 20X手机</span>';
        } elseif($money == 2) {
            $moneyLabel[$money] = '<span class="badge bg-yellow">刘昊然面对面礼盒</span>';
        } else {
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-10">
                    <form class="form-inline" id="searchOrDownload">
                        ...
                        <div class="form-group">
                            <span class="label label-success">分配金额:{{$act1MoneyCount['before']/100-0.21}}元</span>
                        </div>
                        <div class="form-group">
                            <span class="label label-warning">发放金额:{{$act1MoneyCount['after']/100-0.21}}元</span>
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover dataTable" id="ticket-tb">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center;">分配金额(元)<br>奖品</th>
                                    <th style="text-align: center;">发放金额(元)<br>奖品</th>
                                    <th style="text-align: center;width: 290px;">红包详情<br>联系方式</th>
                                ...
                                @foreach($paginator as $ticket)
                                    <tr align="center" id="{{$ticket->id}}">
                                        ...
                                        <td class="money" align="center">
                                            {!! $moneyLabel[$ticket['red_money']]??$moneyLabel[0] !!}
                                        </td>
                                    ...
                                    @else
                                                    ...
                                                    <div class="check_error">
                                                        <div style="text-align: center;">电话:
                                                            <span class="small">
                                                                {{$ticket['phone']}}
                                                            </span>
                                                    </div>
...
@section('js')
    <script>
        ...
        $('#download').click(function (e) {
            ...
            console.log(str);
            // return false;
            location.href = "{{route('l191127.act2.export')}}" + '?' + str;
        });
